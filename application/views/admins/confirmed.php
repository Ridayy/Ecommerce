              ...
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <?php foreach ($orders as $order): ?>
                    <tr> 
                        <td><?= $i ?></td>
                        <td>
                         <?= DateTime::createFromFormat("Y-m-d H:i:s",  $order['ordered_at'])->format("d/m/Y"); ?>
                        ...
                        <td class="actions">
                            ...
                            <a href="<?php echo base_url(). 'orders/set_completed/'.$id; ?>" class="btn btn-primary btn-sm mb-1">Mark As Completed</a><br>
...
function deleteOrder(id){
    bootbox.confirm('Are you sure that you want to delete this order?', function(result){
        ...
        if(result){
           let url = "<?php echo base_url(). 'orders/delete/'?>"+ id + '?page=confirmed';
